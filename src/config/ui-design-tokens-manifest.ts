...
export const UI_PALETTE_COLORS: readonly UiPaletteColor[] = [
  { name: "base-0", value: "oklch(.985 .003 65)" },
  { name: "base-1", value: "oklch(.958 .004 65)" },
  { name: "base-2", value: "oklch(.923 .005 65)" },
  { name: "base-3", value: "oklch(.878 .006 65)" },
  { name: "base-4", value: "oklch(.708 .012 65)" },
  { name: "base-5", value: "oklch(.508 .014 65)" },
  { name: "base-6", value: "oklch(.400 .014 65)" },
  { name: "base-7", value: "oklch(.342 .013 65)" },
  { name: "base-8", value: "oklch(.285 .011 65)" },
  { name: "base-9", value: "oklch(.232 .009 65)" },
  { name: "base-10", value: "oklch(.185 .006 65)" },
  ...
  { name: "line-vacuum-accent", value: "oklch(.538 .100 200)" },
  ...
  { name: "line-meeting-accent", value: "oklch(.536 .132 150)" },
...
export const UI_COLOR_TOKENS: readonly TokenDef[] = [
  ...
  },
  {
    ...
    label: "color-surface",
    group: "surface",
    default: "light-dark(var(--palette-base-1), var(--palette-base-9))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    group: "surface",
    default: "light-dark(var(--palette-base-2), var(--palette-base-8))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    label: "color-border",
    group: "surface",
    default: "light-dark(var(--palette-base-3), var(--palette-base-7))",
    step: 1,
    unit: "",
    control: "text",
  },
  ...
  },
  {
    ...
    label: "color-fg",
    group: "text",
    default: "light-dark(var(--palette-base-8), var(--palette-base-2))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    label: "color-muted",
    group: "text",
    default: "light-dark(var(--palette-base-5), var(--palette-base-4))",
    step: 1,
    unit: "",
    control: "text",
  },
