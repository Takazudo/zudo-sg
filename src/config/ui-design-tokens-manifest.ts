...
export const UI_COLOR_TOKENS: readonly TokenDef[] = [
  // --- Ink (foreground text) ---
  {
    ...
    label: "color-ink",
    group: "ink",
    default: "light-dark(oklch(0.21 0.03 264), oklch(0.93 0.01 264))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    group: "ink",
    default: "light-dark(oklch(0.44 0.02 264), oklch(0.72 0.015 264))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    group: "ink",
    default: "light-dark(oklch(0.58 0.015 264), oklch(0.58 0.012 264))",
    step: 1,
    unit: "",
    control: "text",
  },
  ...
  // --- Paper & surfaces ---
  {
    ...
    label: "color-paper",
    group: "surface",
    default: "light-dark(oklch(0.99 0.004 90), oklch(0.17 0.01 264))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    label: "color-surface",
    group: "surface",
    default: "light-dark(oklch(1 0 0), oklch(0.21 0.012 264))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    group: "surface",
    default: "light-dark(oklch(0.97 0.006 90), oklch(0.25 0.014 264))",
    step: 1,
    unit: "",
    control: "text",
  },
  ...
  // --- Lines / borders ---
  {
    ...
    label: "color-line",
    group: "line",
    default: "light-dark(oklch(0.91 0.008 90), oklch(0.32 0.014 264))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    group: "line",
    default: "light-dark(oklch(0.83 0.01 90), oklch(0.42 0.016 264))",
    step: 1,
    unit: "",
    control: "text",
  },
  ...
  // --- Brand ---
  {
    ...
    label: "color-brand",
    group: "brand",
    default: "light-dark(oklch(0.52 0.13 200), oklch(0.74 0.12 200))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    group: "brand",
    default: "light-dark(oklch(0.44 0.13 200), oklch(0.82 0.11 200))",
    step: 1,
    unit: "",
    control: "text",
  },
  ...
  // --- State: accent ---
  {
    ...
    label: "color-accent",
    group: "state",
    default: "light-dark(oklch(0.70 0.16 55), oklch(0.78 0.14 55))",
    step: 1,
    unit: "",
    control: "text",
  },
  ...
  // --- State: success ---
  {
    ...
    label: "color-success",
    group: "state",
    default: "light-dark(oklch(0.55 0.14 155), oklch(0.74 0.14 155))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    group: "state",
    default: "light-dark(oklch(0.95 0.04 155), oklch(0.30 0.05 155))",
    step: 1,
    unit: "",
    control: "text",
  },
  ...
  // --- State: danger ---
  {
    ...
    label: "color-danger",
    group: "state",
    default: "light-dark(oklch(0.55 0.18 25), oklch(0.72 0.16 25))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    group: "state",
    default: "light-dark(oklch(0.95 0.04 25), oklch(0.30 0.06 25))",
    step: 1,
    unit: "",
    control: "text",
  },
