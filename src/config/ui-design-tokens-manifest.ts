...
export const UI_PALETTE_COLORS: readonly UiPaletteColor[] = [
  { name: "white-0", value: "oklch(1 0 0)" },
  { name: "cool-0", value: "oklch(0.93 0.01 264)" },
  { name: "cool-1", value: "oklch(0.72 0.015 264)" },
  { name: "cool-2", value: "oklch(0.58 0.015 264)" },
  { name: "cool-3", value: "oklch(0.58 0.012 264)" },
  { name: "cool-4", value: "oklch(0.44 0.02 264)" },
  { name: "cool-5", value: "oklch(0.42 0.016 264)" },
  { name: "cool-6", value: "oklch(0.32 0.014 264)" },
  { name: "cool-7", value: "oklch(0.25 0.014 264)" },
  { name: "cool-8", value: "oklch(0.21 0.03 264)" },
  { name: "cool-9", value: "oklch(0.21 0.012 264)" },
  { name: "cool-10", value: "oklch(0.17 0.01 264)" },
  { name: "warm-0", value: "oklch(0.99 0.004 90)" },
  { name: "warm-1", value: "oklch(0.97 0.006 90)" },
  { name: "warm-2", value: "oklch(0.91 0.008 90)" },
  { name: "warm-3", value: "oklch(0.83 0.01 90)" },
  { name: "brand-0", value: "oklch(0.96 0.03 200)" },
  { name: "brand-1", value: "oklch(0.82 0.11 200)" },
  { name: "brand-2", value: "oklch(0.74 0.12 200)" },
  { name: "brand-3", value: "oklch(0.52 0.13 200)" },
  { name: "brand-4", value: "oklch(0.44 0.13 200)" },
  { name: "brand-5", value: "oklch(0.30 0.05 200)" },
  { name: "accent-0", value: "oklch(0.78 0.14 55)" },
  { name: "accent-1", value: "oklch(0.70 0.16 55)" },
  { name: "success-0", value: "oklch(0.95 0.04 155)" },
  { name: "success-1", value: "oklch(0.74 0.14 155)" },
  { name: "success-2", value: "oklch(0.55 0.14 155)" },
  { name: "success-3", value: "oklch(0.30 0.05 155)" },
  { name: "danger-0", value: "oklch(0.95 0.04 25)" },
  { name: "danger-1", value: "oklch(0.72 0.16 25)" },
  { name: "danger-2", value: "oklch(0.55 0.18 25)" },
  { name: "danger-3", value: "oklch(0.30 0.06 25)" },
];
...
export const UI_COLOR_TOKENS: readonly TokenDef[] = [
  ...
  },
  {
    ...
    group: "ink",
    default: "light-dark(var(--palette-cool-4), var(--palette-cool-1))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    group: "ink",
    default: "light-dark(var(--palette-cool-2), var(--palette-cool-3))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    label: "color-paper",
    group: "surface",
    default: "light-dark(var(--palette-warm-0), var(--palette-cool-10))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    label: "color-surface",
    group: "surface",
    default: "light-dark(var(--palette-white-0), var(--palette-cool-9))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    group: "surface",
    default: "light-dark(var(--palette-warm-1), var(--palette-cool-7))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    label: "color-line",
    group: "line",
    default: "light-dark(var(--palette-warm-2), var(--palette-cool-6))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    group: "line",
    default: "light-dark(var(--palette-warm-3), var(--palette-cool-5))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    label: "color-brand",
    group: "brand",
    default: "light-dark(var(--palette-brand-3), var(--palette-brand-2))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    group: "brand",
    default: "light-dark(var(--palette-brand-4), var(--palette-brand-1))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    group: "brand",
    default: "light-dark(var(--palette-brand-0), var(--palette-brand-5))",
    step: 1,
    unit: "",
    control: "text",
  },
  ...
  },
  {
    ...
    label: "color-accent",
    group: "state",
    default: "light-dark(var(--palette-accent-1), var(--palette-accent-0))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    label: "color-success",
    group: "state",
    default: "light-dark(var(--palette-success-2), var(--palette-success-1))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    group: "state",
    default: "light-dark(var(--palette-success-0), var(--palette-success-3))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    label: "color-danger",
    group: "state",
    default: "light-dark(var(--palette-danger-2), var(--palette-danger-1))",
    step: 1,
    unit: "",
    control: "text",
  },
  {
    ...
    group: "state",
    default: "light-dark(var(--palette-danger-0), var(--palette-danger-3))",
    step: 1,
    unit: "",
    control: "text",
  },
