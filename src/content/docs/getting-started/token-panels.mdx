...
|---|---|---|
| **Button label** | "Tokens" (header) | "Preview tokens" (header), "Preview tokens →" (/components/tokens toolbar) |
...
| **Toggle event** | `toggle-design-token-panel` | `toggle-preview-token-panel` |

## Doc-chrome panel ("Tokens")

Click the **Tokens** button in the header to open this panel.
...
Click the **Preview tokens** button in the header (or the "Preview tokens →" button on the `/components/tokens` toolbar) to open this panel.
