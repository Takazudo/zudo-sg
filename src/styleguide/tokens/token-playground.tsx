...
// Interactive layer for the `/sg/tokens` reference. The swatch/spacing/type
// rows are SERVER-RENDERED (no-JS users still see the full token reference);
...
//
// Contract with the SSR markup (pages/sg/tokens.tsx):
...
//   - A `[data-sg-token-toast]` element is the (initially hidden) toast host.

import type { JSX } from "preact";
import { useEffect, useRef, useState } from "preact/hooks";
import { copyText } from "@/styleguide/copy/copy-button";
