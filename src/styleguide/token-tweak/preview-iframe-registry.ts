// Bridges the @takazudo/zdtp design-token tweaker to the styleguide preview
// iframes. Adapted from zzmod's `preview-iframe-registry.ts`.
//
...
//
// This is the same channel the host's docs site uses to theme its own preview
// surfaces, so it is guaranteed compatible with the installed zudo-doc/zdtp
// versions.
