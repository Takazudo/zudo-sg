...
// Reusable copy-to-clipboard button island. Used on the Usage block and code
// panel snippets (the source string) and — via CopyValue — on design-token
// swatches/rows. Self-contained: takes the verbatim text to copy as a prop, so
