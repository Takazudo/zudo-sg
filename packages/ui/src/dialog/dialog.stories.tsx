...
const meta: StoryMeta = {
  title: "Dialog",
  category: "Actions",
  // previewRoute intentionally omitted (#235): the /preview/dialog MSW demo
  // was retargeted onto the ported ContactForm ahead of Dialog's own removal
  // in the Wave-6 atomic swap — see ContactForm's stories.tsx for the current
  // previewRoute escape-hatch demo (packages/ui/STORIES.md §6).
  description:
