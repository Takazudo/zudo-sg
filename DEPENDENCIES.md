...
| `@takazudo/zfb`, `@takazudo/zfb-runtime`, `@takazudo/zfb-md-wasm` | KEEP the aligned 2.20.2 host pins. They provide the CLI, collection/config modules, router, and Markdown runtime. Demo-ui dynamically imports the WASM renderer. Required zudo-doc peers also explain declarations with no local imports. |
