...
// Vendored from zudo-doc's host source (src/components/sidebar-toggle.tsx).
// The mobile sidebar drawer: hamburger button + backdrop + slide-in <aside>
// that hosts the SAME vendored SidebarTree the desktop sidebar uses. Below the
// `lg` breakpoint DocLayout hides the desktop sidebar, so this is the only way
// to reach the nav tree on mobile. `@/…` imports are repointed to the
// styleguide's vendored copies.
//
...
// Soft-nav signal — close the drawer after a client-router page swap.
import { AFTER_NAVIGATE_EVENT } from "@takazudo/zudo-doc/transitions";
import SidebarTree from "./sidebar-tree";
import type { NavNode, LocaleLink } from "./types";
