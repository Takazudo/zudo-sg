...
// you rename here.
//
// The styleguide now renders THROUGH zudo-doc's DocLayout, which owns the
// desktop sidebar (`#desktop-sidebar`). Two consequences for this contract:
...
//     source of truth (`SidebarResizerInit` reads/writes them). Using a
//     styleguide-private key here would be a silent no-op — DocLayout never
//     reads it.
