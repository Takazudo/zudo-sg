...
// Interactive design-token playground (`/tokens`).
//
// This is the SMOKE ROUTE that proves the new chrome: it renders through
// StyleguideLayout, which delegates the 3-region shell to zudo-doc's
// DocLayoutWithDefaults (no bespoke <html>). The swatch / spacing / type rows
// are SERVER-RENDERED (the full token reference is visible with no JS); a
// client island (TokenPlayground) layers the interactivity on top via event
// delegation:
...
// See src/features/token-tweak/token-playground.tsx for the SSR ↔ island
// contract (`data-sg-tokens-root`, `data-sg-token`, `data-var`).
...
import TokenPlayground from "@/features/token-tweak/token-playground";
