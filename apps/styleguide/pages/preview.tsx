...
// Isolated variant-preview route (`/preview`).
//
...
// (zfb injects `<link rel=stylesheet>` for the global CSS into every page),
// so the rendered UI component gets its utility classes + tokens. The
