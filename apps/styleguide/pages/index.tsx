...
// Styleguide catalog landing (`/`). Lists every discovered story grouped by
// category, each linking to its detail page. Discovery is the eager-import
// registry (see src/data/sg-registry.ts).
//
...
// metadata the island reads (see src/features/search/catalog-filter.tsx for
// the contract).
...
import CatalogFilter from "@/features/search/catalog-filter";
